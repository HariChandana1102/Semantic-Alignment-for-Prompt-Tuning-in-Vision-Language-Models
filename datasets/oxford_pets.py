...
class OxfordPets(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        if os.path.exists(self.split_path):
            train, val, test, all_classes = self.read_split(self.split_path, self.image_dir)
        else:
        ...
        super().__init__(train_x=train, val=val, test=test, all_classes=all_classes)
    ...
    def read_split(filepath, path_prefix):
        ...
        train, all_classes = _convert(split["train"])
        val, all_classes = _convert(split["val"])
        test, all_classes = _convert(split["test"])

        return train, val, test, all_classes
